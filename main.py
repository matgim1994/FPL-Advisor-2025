...
# dbhandler.update_teams()
# dbhandler.update_elements()
# dbhandler.update_events()
# dbhandler.update_fixtures()
# dbhandler.update_players_history()
# dbhandler.update_players_fixtures()
dbhandler.update_points_explain()
